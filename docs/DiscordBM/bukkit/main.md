...
**DiscordBM-Bukkit** - клиент который подключается по netty к хостинку DiscordBMV, передает/получает данные, ищет онлайн пользователей, имеет API, выполняет команды
